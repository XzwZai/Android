package com.example.woi.expand1.popmenu;
...
import com.example.woi.expand1.MainActivity;
import com.example.woi.expand1.R;
...
public class PopMenu_WordSize extends PopupWindow {
    ...
    public PopMenu_WordSize(final Activity context, final EditText editText, final int size, final MainActivity mainActivity) {
        super(context);
...
//                seekbar_size.setProgress(num);
        ...
        btn_bgcolor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                popMenu_color = new PopMenu_Color(context,editText,1,mainActivity);
                popMenu_color.showAtLocation(context.findViewById(R.id.activity_main), Gravity.BOTTOM | Gravity.CENTER,0,0);
            }
        });
        btn_wordcolor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                popMenu_color = new PopMenu_Color(context,editText,0,mainActivity);
                popMenu_color.showAtLocation(context.findViewById(R.id.activity_main), Gravity.BOTTOM | Gravity.CENTER,0,0);
            }
        });
