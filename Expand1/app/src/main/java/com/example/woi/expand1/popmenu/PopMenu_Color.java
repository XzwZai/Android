...
public class PopMenu_Color extends PopupWindow {
    ...
    public PopMenu_Color(final Activity context, final EditText editText, int type, final MainActivity mainActivity) {
        super(context);
        edit = editText;
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.black:
                        ...
                        mainActivity.setWordColor(Color.rgb(0,0,0));
                        //edit.setTextColor(Color.rgb(0,0,0));
                        break;
                    case R.id.white:
                        mainActivity.setWordColor(Color.rgb(0xff,0xff,0xff));
                        //edit.setTextColor(Color.rgb(0xff,0xff,0xff));
                        break;
                    case R.id.green:
                        mainActivity.setWordColor(Color.rgb(0,0xff,0));
                        //edit.setTextColor(Color.rgb(0,0xff,0));
                        break;
                    case R.id.red:
                        mainActivity.setWordColor(Color.rgb(0xff,0,0));
                        //edit.setTextColor(Color.rgb(0xff,0,0));
                        break;
                    case R.id.blue:
                        mainActivity.setWordColor(Color.rgb(0,0,0xff));
